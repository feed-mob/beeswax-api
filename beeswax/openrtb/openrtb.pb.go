...
// *
// OpenRTB 2.6: This object describes the network an ad will be displayed on. A Network is
// defined as the parent entity of the Channel object’s entity for the purposes of organizing
// Channels. Examples are companies that own and/or license a collection of content channels
// (Viacom, Discovery, CBS, WarnerMedia, Turner and others), or studio that creates such content
// and self-distributes content. Name is a human-readable field while domain and id can be used for
...
func (*Network) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{4}
}
...
// *
// OpenRTB 2.6: This object describes the channel an ad will be displayed on. A Channel is defined
// as the entity that curates a content library, or stream within a brand name for viewers. Examples
// are specific view selectable ‘channels’ within linear and streaming television (MTV, HGTV, CNN, BBC One, etc)
// or a specific stream of audio content commonly called ‘stations.’ Name is a human-readable field while domain
...
func (*Channel) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{5}
}
...
// *
// UserAgent is the object for Structured User Agent
type UserAgent struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// each of these identifies a browser or similar component
	Browsers []*BrandVersion `protobuf:"bytes,1,rep,name=browsers" json:"browsers,omitempty"`
	// platform / os
	Platform *BrandVersion `protobuf:"bytes,2,opt,name=platform" json:"platform,omitempty"`
	// if the agent prefers mobile version of content (0 if desktop)
	Mobile *int32 `protobuf:"varint,3,opt,name=mobile" json:"mobile,omitempty"`
	// major binary architecture
	Architecture *string `protobuf:"bytes,4,opt,name=architecture" json:"architecture,omitempty"`
	// device bitness, eg "arm" or "x86"
	...
	// source used for this object (so far Client Hints or standard UA string)
...
func (*UserAgent) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{6}
}
...
// Brand Version object used within Structured User Agent object
...
func (*BrandVersion) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{7}
}
...
type BidRequest_Impression struct {
	...
	// Indicates if server-side ad insertion is in use and the impact
	// of this on asset and tracker retrieval, where 0 = status unknown,
	// 1 = all client-side, 2 = assets stitched server-side but
	// tracking pixels fired client-side, 3 = all server-side.
	Ssai          *int32                `protobuf:"varint,17,opt,name=ssai" json:"ssai,omitempty"`
...
func (x *BidRequest_Impression) GetSsai() int32 {
	if x != nil && x.Ssai != nil {
		return *x.Ssai
	}
	return 0
...
type BidRequest_Content struct {
	...
	Genre *string `protobuf:"bytes,20,opt,name=genre" json:"genre,omitempty"`
	// Network Object
	Network *Network `protobuf:"bytes,21,opt,name=network" json:"network,omitempty"`
	// Channel Object
	Channel       *Channel           `protobuf:"bytes,22,opt,name=channel" json:"channel,omitempty"`
...
func (x *BidRequest_Content) GetNetwork() *Network {
	if x != nil {
		return x.Network
	}
	return nil
...
func (x *BidRequest_Content) GetChannel() *Channel {
	if x != nil {
		return x.Channel
	}
	return nil
...
type BidRequest_Device struct {
	...
	// Structured User Agent device identification object which we will use in place of ua when available
	Sua           *UserAgent        `protobuf:"bytes,29,opt,name=sua" json:"sua,omitempty"`
...
func (x *BidRequest_Device) GetSua() *UserAgent {
	if x != nil {
		return x.Sua
	}
	return nil
...
type BidRequest_User struct {
	...
	Eids          []*BidRequest_User_ExtendedID `protobuf:"bytes,9,rep,name=eids" json:"eids,omitempty"`
...
func (x *BidRequest_User) GetEids() []*BidRequest_User_ExtendedID {
	if x != nil {
		return x.Eids
	}
	return nil
...
// OpenRTB 2.6: 3.7.27: Object: Extended identifiers
//
// Extended identifiers support in the OpenRTB specification allows
// buyers to use audience data in real-time bidding. This object can
// contain one or more UIDs from a single source or a technology
// provider. The exchange should ensure that business agreements
// allow for the sending of this data.
type BidRequest_User_ExtendedID struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	Uids          []*BidRequest_User_ExtendedID_UID `protobuf:"bytes,2,rep,name=uids" json:"uids,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *BidRequest_User_ExtendedID) Reset() {
	*x = BidRequest_User_ExtendedID{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[25]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BidRequest_User_ExtendedID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BidRequest_User_ExtendedID) ProtoMessage() {}

func (x *BidRequest_User_ExtendedID) ProtoReflect() protoreflect.Message {
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BidRequest_User_ExtendedID.ProtoReflect.Descriptor instead.
func (*BidRequest_User_ExtendedID) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{0, 6, 0}
}

func (x *BidRequest_User_ExtendedID) GetSource() string {
	if x != nil && x.Source != nil {
		return *x.Source
	}
	return ""
...
func (x *BidRequest_User_ExtendedID) GetUids() []*BidRequest_User_ExtendedID_UID {
	if x != nil {
		return x.Uids
	}
	return nil
...
// OpenRTB 2.6: 3.7.28: Object: Extended Identifier UIDs
//
// This object contains a single user identifier provided as
// part of extended identifiers. The exchange should ensure that
// business agreements allow for the sending of this data.
type BidRequest_User_ExtendedID_UID struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Id    *string                `protobuf:"bytes,1,opt,name=id" json:"id,omitempty"`
	// AdCOM 1.0 List: AgentTypes
	//
	// This list identifies the user agent types a user
	// identifier is from.
	//
	// 1: An ID which is tied to a specific web browser or
	//
	//	device (cookie-based, probabilistic, or other).
	//
	// 2: In-app impressions, which will typically contain a
	//
	//	type of device ID (or rather, the privacy-compliant
	//	versions of device IDs).
	//
	// 3: A person-based ID, i.e., that is the same across
	//
	//	devices.
	//
...
func (x *BidRequest_User_ExtendedID_UID) Reset() {
	*x = BidRequest_User_ExtendedID_UID{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[26]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *BidRequest_User_ExtendedID_UID) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BidRequest_User_ExtendedID_UID) ProtoMessage() {}

func (x *BidRequest_User_ExtendedID_UID) ProtoReflect() protoreflect.Message {
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[26]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BidRequest_User_ExtendedID_UID.ProtoReflect.Descriptor instead.
func (*BidRequest_User_ExtendedID_UID) Descriptor() ([]byte, []int) {
	return file_beeswax_openrtb_openrtb_proto_rawDescGZIP(), []int{0, 6, 0, 0}
}

func (x *BidRequest_User_ExtendedID_UID) GetId() string {
	if x != nil && x.Id != nil {
		return *x.Id
	}
	return ""
...
func (x *BidRequest_User_ExtendedID_UID) GetAtype() int32 {
...
func (x *NativeResponse_Link) Reset() {
	*x = NativeResponse_Link{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[34]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NativeResponse_Asset) Reset() {
	*x = NativeResponse_Asset{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[35]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NativeResponse_Asset_Title) Reset() {
	*x = NativeResponse_Asset_Title{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[36]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NativeResponse_Asset_Image) Reset() {
	*x = NativeResponse_Asset_Image{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[37]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NativeResponse_Asset_Data) Reset() {
	*x = NativeResponse_Asset_Data{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[38]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NativeResponse_Asset_Video) Reset() {
	*x = NativeResponse_Asset_Video{}
	mi := &file_beeswax_openrtb_openrtb_proto_msgTypes[39]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_beeswax_openrtb_openrtb_proto_rawDesc = "" +
	"\n" +
	"\x1dbeeswax/openrtb/openrtb.proto\x12\aopenrtb\x1a\x1fbeeswax/openrtb/extension.proto\x1a$beeswax/openrtb/openrtb_common.proto\"\x81A\n" +
	"\n" +
	"BidRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x120\n" +
	"\x03imp\x18\x02 \x03(\v2\x1e.openrtb.BidRequest.ImpressionR\x03imp\x12,\n" +
	"\x04site\x18\x03 \x01(\v2\x18.openrtb.BidRequest.SiteR\x04site\x12)\n" +
	"\x03app\x18\x04 \x01(\v2\x17.openrtb.BidRequest.AppR\x03app\x122\n" +
	"\x06device\x18\x05 \x01(\v2\x1a.openrtb.BidRequest.DeviceR\x06device\x12,\n" +
	"\x04user\x18\x06 \x01(\v2\x18.openrtb.BidRequest.UserR\x04user\x12\x19\n" +
	...
	"\x05wseat\x18\t \x03(\tR\x05wseat\x12+\n" +
	"\aallimps\x18\n" +
	" \x01(\x0e2\r.openrtb.Flag:\x02NOR\aallimps\x12\x10\n" +
	"\x03cur\x18\v \x03(\tR\x03cur\x12\x12\n" +
	"\x04bcat\x18\f \x03(\tR\x04bcat\x12\x12\n" +
	"\x04badv\x18\r \x03(\tR\x04badv\x12\x12\n" +
	"\x04bapp\x18\x10 \x03(\tR\x04bapp\x123\n" +
	"\x04regs\x18\x0e \x01(\v2\x1f.openrtb.BidRequest.RegulationsR\x04regs\x122\n" +
	"\x06source\x18\x13 \x01(\v2\x1a.openrtb.BidRequest.SourceR\x06source\x120\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1d.openrtb.BidRequestExtensionsR\x03ext\x1aI\n" +
	"\x06Source\x12\x0e\n" +
	"\x02fd\x18\x01 \x01(\bR\x02fd\x12\x10\n" +
	"\x03tid\x18\x02 \x01(\tR\x03tid\x12\x16\n" +
	"\x06pchain\x18\x03 \x01(\tR\x06pchain*\x05\bd\x10\x90N\x1a\xbc\x19\n" +
	"\n" +
	"Impression\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x12=\n" +
	"\x06banner\x18\x02 \x01(\v2%.openrtb.BidRequest.Impression.BannerR\x06banner\x12:\n" +
	"\x05video\x18\x03 \x01(\v2$.openrtb.BidRequest.Impression.VideoR\x05video\x12=\n" +
	"\x06native\x18\r \x01(\v2%.openrtb.BidRequest.Impression.NativeR\x06native\x12&\n" +
	"\x0edisplaymanager\x18\x04 \x01(\tR\x0edisplaymanager\x12,\n" +
	"\x11displaymanagerver\x18\x05 \x01(\tR\x11displaymanagerver\x12'\n" +
	"\x05instl\x18\x06 \x01(\x0e2\r.openrtb.Flag:\x02NOR\x05instl\x12\x14\n" +
	...
	"\fclickbrowser\x18\x10 \x01(\bR\fclickbrowser\x12\"\n" +
	"\fiframebuster\x18\n" +
	" \x03(\tR\fiframebuster\x124\n" +
	"\x03pmp\x18\v \x01(\v2\".openrtb.BidRequest.Impression.PMPR\x03pmp\x12\x16\n" +
	"\x06secure\x18\f \x01(\x05R\x06secure\x12\x10\n" +
	"\x03exp\x18\x0e \x01(\x05R\x03exp\x12\x12\n" +
	"\x04ssai\x18\x11 \x01(\x05R\x04ssai\x120\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1d.openrtb.ImpressionExtensionsR\x03ext\x1a\xe6\x04\n" +
	"\x06Banner\x12\f\n" +
	"\x01w\x18\x01 \x01(\x05R\x01w\x12\f\n" +
	"\x01h\x18\x02 \x01(\x05R\x01h\x12\x12\n" +
	"\x04wmax\x18\v \x01(\x05R\x04wmax\x12\x12\n" +
	"\x04hmax\x18\f \x01(\x05R\x04hmax\x12\x12\n" +
	"\x04wmin\x18\r \x01(\x05R\x04wmin\x12\x12\n" +
	"\x04hmin\x18\x0e \x01(\x05R\x04hmin\x12\x0e\n" +
	"\x02id\x18\x03 \x01(\tR\x02id\x12S\n" +
	"\x03pos\x18\x04 \x01(\x0e2/.openrtb.Enums.BidRequest.Impression.AdPosition:\x10POSITION_UNKNOWNR\x03pos\x12H\n" +
	"\x05btype\x18\x05 \x03(\x0e22.openrtb.Enums.BidRequest.Impression.Banner.AdTypeR\x05btype\x120\n" +
	"\x05battr\x18\x06 \x03(\x0e2\x1a.openrtb.CreativeAttributeR\x05battr\x12\x14\n" +
	"\x05mimes\x18\a \x03(\tR\x05mimes\x12-\n" +
	"\btopframe\x18\b \x01(\x0e2\r.openrtb.Flag:\x02NOR\btopframe\x12W\n" +
	"\x06expdir\x18\t \x03(\x0e2?.openrtb.Enums.BidRequest.Impression.Banner.ExpandableDirectionR\x06expdir\x12C\n" +
	"\x03api\x18\n" +
	" \x03(\x0e21.openrtb.Enums.BidRequest.Impression.ApiFrameworkR\x03api\x12,\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x19.openrtb.BannerExtensionsR\x03ext\x1a\xac\n" +
	"\n" +
	"\x05Video\x12\x14\n" +
	"\x05mimes\x18\x01 \x03(\tR\x05mimes\x12Z\n" +
	"\tlinearity\x18\x02 \x01(\x0e24.openrtb.Enums.BidRequest.Impression.Video.Linearity:\x06LINEARR\tlinearity\x12 \n" +
	"\vminduration\x18\x03 \x01(\x05R\vminduration\x12 \n" +
	"\vmaxduration\x18\x04 \x01(\x05R\vmaxduration\x12Q\n" +
	"\tprotocols\x18\x05 \x03(\x0e23.openrtb.Enums.BidRequest.Impression.Video.ProtocolR\tprotocols\x12\f\n" +
	"\x01w\x18\x06 \x01(\x05R\x01w\x12\f\n" +
	"\x01h\x18\a \x01(\x05R\x01h\x12\"\n" +
	"\n" +
	"startdelay\x18\b \x01(\x05:\x02-3R\n" +
	"startdelay\x12\x1d\n" +
	"\bsequence\x18\t \x01(\x05:\x011R\bsequence\x120\n" +
	"\x05battr\x18\n" +
	" \x03(\x0e2\x1a.openrtb.CreativeAttributeR\x05battr\x12#\n" +
	"\vmaxextended\x18\v \x01(\x05:\x010R\vmaxextended\x12\x1e\n" +
	"\n" +
	...
	"maxbitrate\x128\n" +
	"\rboxingallowed\x18\x0e \x01(\x0e2\r.openrtb.Flag:\x03YESR\rboxingallowed\x12a\n" +
	"\x0eplaybackmethod\x18\x0f \x03(\x0e29.openrtb.Enums.BidRequest.Impression.Video.PlaybackMethodR\x0eplaybackmethod\x12V\n" +
	"\bdelivery\x18\x10 \x03(\x0e2:.openrtb.Enums.BidRequest.Impression.Video.ContentDeliveryR\bdelivery\x12S\n" +
	"\x03pos\x18\x11 \x01(\x0e2/.openrtb.Enums.BidRequest.Impression.AdPosition:\x10POSITION_UNKNOWNR\x03pos\x12G\n" +
	"\vcompanionad\x18\x12 \x03(\v2%.openrtb.BidRequest.Impression.BannerR\vcompanionad\x12C\n" +
	"\x03api\x18\x13 \x03(\x0e21.openrtb.Enums.BidRequest.Impression.ApiFrameworkR\x03api\x12^\n" +
	"\rcompaniontype\x18\x14 \x03(\x0e28.openrtb.Enums.BidRequest.Impression.Video.CompanionTypeR\rcompaniontype\x12[\n" +
	"\tplacement\x18\x1a \x01(\x0e2=.openrtb.Enums.BidRequest.Impression.Video.VideoPlacementTypeR\tplacement\x12b\n" +
	"\vplaybackend\x18\x1b \x01(\x0e2@.openrtb.Enums.BidRequest.Impression.Video.PlaybackCessationModeR\vplaybackend\x12+\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x18.openrtb.VideoExtensionsR\x03ext\x1a\xf9\x01\n" +
	"\x06Native\x120\n" +
	"\arequest\x18\x01 \x02(\v2\x16.openrtb.NativeRequestR\arequest\x12\x10\n" +
	"\x03ver\x18\x02 \x01(\tR\x03ver\x12G\n" +
	"\x03api\x18\x03 \x03(\x0e21.openrtb.Enums.BidRequest.Impression.ApiFrameworkB\x02\x10\x01R\x03api\x124\n" +
	"\x05battr\x18\x04 \x03(\x0e2\x1a.openrtb.CreativeAttributeB\x02\x10\x01R\x05battr\x12,\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x19.openrtb.NativeExtensionsR\x03ext\x1a\x86\x03\n" +
	"\x03PMP\x126\n" +
	"\x0fprivate_auction\x18\x01 \x01(\x0e2\r.openrtb.FlagR\x0eprivateAuction\x12C\n" +
	"\x05deals\x18\x02 \x03(\v2-.openrtb.BidRequest.Impression.PMP.DirectDealR\x05deals\x12)\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x16.openrtb.PMPExtensionsR\x03ext\x1a\xd6\x01\n" +
	"\n" +
	"DirectDeal\x12\x0e\n" +
	...
	"\bwadomain\x18\x05 \x03(\tR\bwadomain\x12\x0e\n" +
	"\x02at\x18\x06 \x01(\x05R\x02at\x120\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1d.openrtb.DirectDealExtensionsR\x03ext\x1a\xd5\x03\n" +
	"\x04Site\x12\x0e\n" +
	...
	"\x04page\x18\a \x01(\tR\x04page\x123\n" +
	"\rprivacypolicy\x18\b \x01(\x0e2\r.openrtb.FlagR\rprivacypolicy\x12\x10\n" +
	"\x03ref\x18\n" +
	" \x01(\tR\x03ref\x12\x16\n" +
	"\x06search\x18\v \x01(\tR\x06search\x12\x16\n" +
	"\x06mobile\x18\x0f \x01(\bR\x06mobile\x12;\n" +
	"\tpublisher\x18\f \x01(\v2\x1d.openrtb.BidRequest.PublisherR\tpublisher\x125\n" +
	"\acontent\x18\r \x01(\v2\x1b.openrtb.BidRequest.ContentR\acontent\x12\x1a\n" +
	"\bkeywords\x18\x0e \x01(\tR\bkeywords\x12*\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x17.openrtb.SiteExtensionsR\x03ext\x1a\xf2\x03\n" +
	"\x03App\x12\x12\n" +
	"\x02id\x18\x01 \x01(\t:\x02-1R\x02id\x12\x16\n" +
	"\x04name\x18\x02 \x01(\t:\x02-1R\x04name\x12\x16\n" +
	"\x06domain\x18\x03 \x01(\tR\x06domain\x12\x10\n" +
	"\x03cat\x18\x04 \x03(\tR\x03cat\x12\x1e\n" +
	"\n" +
	"sectioncat\x18\x05 \x03(\tR\n" +
	...
	"\x03ver\x18\a \x01(\tR\x03ver\x12\x1a\n" +
	"\x06bundle\x18\b \x01(\t:\x02-1R\x06bundle\x123\n" +
	"\rprivacypolicy\x18\t \x01(\x0e2\r.openrtb.FlagR\rprivacypolicy\x12!\n" +
	"\x04paid\x18\n" +
	" \x01(\x0e2\r.openrtb.FlagR\x04paid\x12;\n" +
	"\tpublisher\x18\v \x01(\v2\x1d.openrtb.BidRequest.PublisherR\tpublisher\x125\n" +
	"\acontent\x18\f \x01(\v2\x1b.openrtb.BidRequest.ContentR\acontent\x12\x1a\n" +
	"\bkeywords\x18\r \x01(\tR\bkeywords\x12\x1a\n" +
	"\bstoreurl\x18\x0e \x01(\tR\bstoreurl\x12)\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x16.openrtb.AppExtensionsR\x03ext\x1a\xc4\a\n" +
	"\aContent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aepisode\x18\x02 \x01(\x05R\aepisode\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x16\n" +
	"\x06series\x18\x04 \x01(\tR\x06series\x12\x16\n" +
	"\x06season\x18\x05 \x01(\tR\x06season\x12\x10\n" +
	"\x03url\x18\x06 \x01(\tR\x03url\x12\x10\n" +
	"\x03cat\x18\a \x03(\tR\x03cat\x12R\n" +
	"\fvideoquality\x18\b \x01(\x0e2..openrtb.Enums.BidRequest.Content.VideoQualityR\fvideoquality\x12\x1a\n" +
	...
	"userrating\x12C\n" +
	"\acontext\x18\f \x01(\x0e2).openrtb.Enums.BidRequest.Content.ContextR\acontext\x12-\n" +
	"\n" +
	"livestream\x18\r \x01(\x0e2\r.openrtb.FlagR\n" +
	"livestream\x12d\n" +
	"\x12sourcerelationship\x18\x0e \x01(\x0e24.openrtb.Enums.BidRequest.Content.SourceRelationshipR\x12sourcerelationship\x128\n" +
	"\bproducer\x18\x0f \x01(\v2\x1c.openrtb.BidRequest.ProducerR\bproducer\x12\x10\n" +
	"\x03len\x18\x10 \x01(\x05R\x03len\x12a\n" +
	"\x0eqagmediarating\x18\x11 \x01(\x0e20.openrtb.Enums.BidRequest.Content.QAGMediaRating:\aUNKNOWNR\x0eqagmediarating\x12-\n" +
	"\n" +
	"embeddable\x18\x12 \x01(\x0e2\r.openrtb.FlagR\n" +
	"embeddable\x12\x1a\n" +
	"\blanguage\x18\x13 \x01(\tR\blanguage\x12\x14\n" +
	"\x05genre\x18\x14 \x01(\tR\x05genre\x12*\n" +
	"\anetwork\x18\x15 \x01(\v2\x10.openrtb.NetworkR\anetwork\x12*\n" +
	"\achannel\x18\x16 \x01(\v2\x10.openrtb.ChannelR\achannel\x12-\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1a.openrtb.ContentExtensionsR\x03ext\x1a\xae\a\n" +
	"\x06Device\x12\x1f\n" +
	"\x03dnt\x18\x01 \x01(\x0e2\r.openrtb.FlagR\x03dnt\x12\x0e\n" +
	"\x02ua\x18\x02 \x01(\tR\x02ua\x12\x17\n" +
	"\x02ip\x18\x03 \x01(\t:\a0.0.0.0R\x02ip\x12)\n" +
	"\x03geo\x18\x04 \x01(\v2\x17.openrtb.BidRequest.GeoR\x03geo\x12\x18\n" +
	"\adidsha1\x18\x05 \x01(\tR\adidsha1\x12\x16\n" +
	"\x06didmd5\x18\x06 \x01(\tR\x06didmd5\x12\x1a\n" +
	"\bdpidsha1\x18\a \x01(\tR\bdpidsha1\x12\x18\n" +
	"\adpidmd5\x18\b \x01(\tR\adpidmd5\x12\x12\n" +
	"\x04ipv6\x18\t \x01(\tR\x04ipv6\x12\x1c\n" +
	"\acarrier\x18\n" +
	" \x01(\t:\x02-1R\acarrier\x12\x1a\n" +
	"\blanguage\x18\v \x01(\tR\blanguage\x12\x16\n" +
	"\x04make\x18\f \x01(\t:\x02-1R\x04make\x12\x18\n" +
	"\x05model\x18\r \x01(\t:\x02-1R\x05model\x12\x12\n" +
	"\x02os\x18\x0e \x01(\t:\x02-1R\x02os\x12\x14\n" +
	"\x03osv\x18\x0f \x01(\t:\x02-1R\x03osv\x12\"\n" +
	"\x02js\x18\x10 \x01(\x0e2\r.openrtb.Flag:\x03YESR\x02js\x12k\n" +
	"\x0econnectiontype\x18\x11 \x01(\x0e2/.openrtb.Enums.BidRequest.Device.ConnectionType:\x12CONNECTION_UNKNOWNR\x0econnectiontype\x12T\n" +
	"\n" +
	"devicetype\x18\x12 \x01(\x0e2+.openrtb.Enums.BidRequest.Device.DeviceType:\aUNKNOWNR\n" +
	"devicetype\x12\x1a\n" +
	"\bflashver\x18\x13 \x01(\tR\bflashver\x12\x10\n" +
	"\x03lmt\x18\x14 \x01(\bR\x03lmt\x12\x10\n" +
	"\x03hwv\x18\x15 \x01(\tR\x03hwv\x12\f\n" +
	"\x01w\x18\x16 \x01(\x05R\x01w\x12\f\n" +
	"\x01h\x18\x17 \x01(\x05R\x01h\x12\x10\n" +
	"\x03ppi\x18\x18 \x01(\x05R\x03ppi\x12\x18\n" +
	"\apxratio\x18\x19 \x01(\x01R\apxratio\x12\x10\n" +
	"\x03ifa\x18\x1a \x01(\tR\x03ifa\x12\x18\n" +
	"\amacsha1\x18\x1b \x01(\tR\amacsha1\x12\x16\n" +
	"\x06macmd5\x18\x1c \x01(\tR\x06macmd5\x12\x16\n" +
	"\x06mccmnc\x18\x1e \x01(\tR\x06mccmnc\x12$\n" +
	"\x03sua\x18\x1d \x01(\v2\x12.openrtb.UserAgentR\x03sua\x12,\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x19.openrtb.DeviceExtensionsR\x03ext\x1a\xe7\x03\n" +
	"\x04User\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x1a\n" +
	"\bbuyeruid\x18\x02 \x01(\tR\bbuyeruid\x12\x10\n" +
	"\x03yob\x18\x03 \x01(\x05R\x03yob\x12\x16\n" +
	"\x06gender\x18\x04 \x01(\tR\x06gender\x12\x1a\n" +
	"\bkeywords\x18\x05 \x01(\tR\bkeywords\x12\x1e\n" +
	"\n" +
	"customdata\x18\x06 \x01(\tR\n" +
	"customdata\x12)\n" +
	"\x03geo\x18\a \x01(\v2\x17.openrtb.BidRequest.GeoR\x03geo\x12,\n" +
	"\x04data\x18\b \x03(\v2\x18.openrtb.BidRequest.DataR\x04data\x127\n" +
	"\x04eids\x18\t \x03(\v2#.openrtb.BidRequest.User.ExtendedIDR\x04eids\x12*\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x17.openrtb.UserExtensionsR\x03ext\x1a\x8e\x01\n" +
	"\n" +
	"ExtendedID\x12\x16\n" +
	"\x06source\x18\x01 \x01(\tR\x06source\x12;\n" +
	"\x04uids\x18\x02 \x03(\v2'.openrtb.BidRequest.User.ExtendedID.UIDR\x04uids\x1a+\n" +
	"\x03UID\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x14\n" +
	"\x05atype\x18\x02 \x01(\x05R\x05atype\x1a\x8a\x01\n" +
	"\tPublisher\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x10\n" +
	"\x03cat\x18\x03 \x03(\tR\x03cat\x12\x16\n" +
	"\x06domain\x18\x04 \x01(\tR\x06domain\x12/\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1c.openrtb.PublisherExtensionsR\x03ext\x1a\x88\x01\n" +
	"\bProducer\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x10\n" +
	"\x03cat\x18\x03 \x03(\tR\x03cat\x12\x16\n" +
	"\x06domain\x18\x04 \x01(\tR\x06domain\x12.\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1b.openrtb.ProducerExtensionsR\x03ext\x1a\xc6\x02\n" +
	"\x03Geo\x12\x10\n" +
	...
	"\x04type\x18\t \x01(\x0e2*.openrtb.Enums.BidRequest.Geo.LocationTypeR\x04type\x12\x1c\n" +
	"\tutcoffset\x18\n" +
	" \x01(\x05R\tutcoffset\x12)\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x16.openrtb.GeoExtensionsR\x03ext\x1a\x86\x02\n" +
	"\x04Data\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12:\n" +
	"\asegment\x18\x03 \x03(\v2 .openrtb.BidRequest.Data.SegmentR\asegment\x12*\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x17.openrtb.DataExtensionsR\x03ext\x1ar\n" +
	"\aSegment\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05value\x18\x03 \x01(\tR\x05value\x12-\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1a.openrtb.SegmentExtensionsR\x03ext\x1ae\n" +
	"\vRegulations\x12#\n" +
	"\x05coppa\x18\x01 \x01(\x0e2\r.openrtb.FlagR\x05coppa\x121\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1e.openrtb.RegulationsExtensionsR\x03ext\"\xfa\x06\n" +
	"\vBidResponse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x126\n" +
	"\aseatbid\x18\x02 \x03(\v2\x1c.openrtb.BidResponse.SeatBidR\aseatbid\x12\x14\n" +
	"\x05bidid\x18\x03 \x01(\tR\x05bidid\x12\x15\n" +
	"\x03cur\x18\x04 \x01(\t:\x03USDR\x03cur\x12\x1e\n" +
	"\n" +
	"customdata\x18\x05 \x01(\tR\n" +
	"customdata\x128\n" +
	"\x03nbr\x18\x06 \x01(\x0e2&.openrtb.Enums.BidResponse.NoBidReasonR\x03nbr\x121\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1e.openrtb.BidResponseExtensionsR\x03ext\x1a\xe8\x04\n" +
	"\aSeatBid\x122\n" +
	"\x03bid\x18\x01 \x03(\v2 .openrtb.BidResponse.SeatBid.BidR\x03bid\x12\x12\n" +
	"\x04seat\x18\x02 \x01(\tR\x04seat\x12#\n" +
	"\x05group\x18\x03 \x01(\x0e2\r.openrtb.FlagR\x05group\x12-\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x1a.openrtb.SeatBidExtensionsR\x03ext\x1a\xc0\x03\n" +
	"\x03Bid\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\tR\x02id\x12\x14\n" +
	"\x05impid\x18\x02 \x02(\tR\x05impid\x12\x14\n" +
	"\x05price\x18\x03 \x02(\x01R\x05price\x12\x12\n" +
	"\x04adid\x18\x04 \x01(\tR\x04adid\x12\x12\n" +
	"\x04nurl\x18\x05 \x01(\tR\x04nurl\x12\x10\n" +
	"\x03adm\x18\x06 \x01(\tR\x03adm\x126\n" +
	"\n" +
	"adm_native\x182 \x01(\v2\x17.openrtb.NativeResponseR\tadmNative\x12\x18\n" +
	"\aadomain\x18\a \x03(\tR\aadomain\x12\x16\n" +
	"\x06bundle\x18\x0f \x01(\tR\x06bundle\x12\x12\n" +
	"\x04iurl\x18\b \x01(\tR\x04iurl\x12\x10\n" +
	"\x03cid\x18\t \x01(\tR\x03cid\x12\x12\n" +
	"\x04crid\x18\n" +
	" \x01(\tR\x04crid\x12\x10\n" +
	"\x03cat\x18\x10 \x03(\tR\x03cat\x12.\n" +
	"\x04attr\x18\v \x03(\x0e2\x1a.openrtb.CreativeAttributeR\x04attr\x12\x16\n" +
	"\x06dealid\x18\f \x01(\tR\x06dealid\x12\f\n" +
	"\x01w\x18\r \x01(\x05R\x01w\x12\f\n" +
	"\x01h\x18\x0e \x01(\x05R\x01h\x12)\n" +
	"\x03ext\x18\xe8\a \x01(\v2\x16.openrtb.BidExtensionsR\x03ext\"\x9a\v\n" +
	"\rNativeRequest\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\tR\x03ver\x12S\n" +
	"\x06layout\x18\x02 \x01(\x0e2;.openrtb.Enums.BidRequest.Impression.NativeRequest.LayoutIdR\x06layout\x12S\n" +
	"\x06adunit\x18\x03 \x01(\x0e2;.openrtb.Enums.BidRequest.Impression.NativeRequest.AdUnitIdR\x06adunit\x12\x1d\n" +
	"\bplcmtcnt\x18\x04 \x01(\x05:\x011R\bplcmtcnt\x12\x13\n" +
	"\x03seq\x18\x05 \x01(\x05:\x010R\x03seq\x124\n" +
	"\x06assets\x18\x06 \x03(\v2\x1c.openrtb.NativeRequest.AssetR\x06assets\x12T\n" +
	"\acontext\x18\a \x01(\x0e2:.openrtb.Enums.BidRequest.Impression.NativeRequest.ContextR\acontext\x12i\n" +
	"\x0econtextsubtype\x18\b \x01(\x0e2A.openrtb.Enums.BidRequest.Impression.NativeRequest.ContextSubtypeR\x0econtextsubtype\x12^\n" +
	"\tplcmttype\x18\t \x01(\x0e2@.openrtb.Enums.BidRequest.Impression.NativeRequest.PlacementTypeR\tplcmttype\x1a\xba\x06\n" +
	"\x05Asset\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x05R\x02id\x12!\n" +
	"\brequired\x18\x02 \x01(\b:\x05falseR\brequired\x128\n" +
	"\x05title\x18\x03 \x01(\v2\".openrtb.NativeRequest.Asset.TitleR\x05title\x124\n" +
	"\x03img\x18\x04 \x01(\v2\".openrtb.NativeRequest.Asset.ImageR\x03img\x12:\n" +
	"\x05video\x18\x05 \x01(\v2$.openrtb.BidRequest.Impression.VideoR\x05video\x125\n" +
	"\x04data\x18\x06 \x01(\v2!.openrtb.NativeRequest.Asset.DataR\x04data\x1a \n" +
	"\x05Title\x12\x10\n" +
	"\x03len\x18\x01 \x02(\x05R\x03len*\x05\bd\x10\x90N\x1a\xdf\x01\n" +
	"\x05Image\x12E\n" +
	"\x04type\x18\x01 \x01(\x0e21.openrtb.NativeRequest.Asset.Image.ImageAssetTypeR\x04type\x12\f\n" +
	...
	"\x05mimes\x18\x06 \x03(\tR\x05mimes\".\n" +
	"\x0eImageAssetType\x12\b\n" +
	"\x04ICON\x10\x01\x12\b\n" +
	"\x04LOGO\x10\x02\x12\b\n" +
	"\x04MAIN\x10\x03*\x05\bd\x10\x90N\x1a\x8f\x02\n" +
	"\x04Data\x12C\n" +
	"\x04type\x18\x01 \x01(\x0e2/.openrtb.NativeRequest.Asset.Data.DataAssetTypeR\x04type\x12\x10\n" +
	"\x03len\x18\x02 \x01(\x05R\x03len\"\xa8\x01\n" +
	"\rDataAssetType\x12\r\n" +
	...
	"\aCTATEXT\x10\f*\x05\bd\x10\x90N*\x05\bd\x10\x90N*\x05\bd\x10\x90N\"\xd7\x06\n" +
	"\x0eNativeResponse\x12\x10\n" +
	"\x03ver\x18\x01 \x01(\tR\x03ver\x125\n" +
	"\x06assets\x18\x02 \x03(\v2\x1d.openrtb.NativeResponse.AssetR\x06assets\x120\n" +
	"\x04link\x18\x03 \x02(\v2\x1c.openrtb.NativeResponse.LinkR\x04link\x12 \n" +
	"\vimptrackers\x18\x04 \x03(\tR\vimptrackers\x12\x1c\n" +
	"\tjstracker\x18\x05 \x01(\tR\tjstracker\x1aa\n" +
	"\x04Link\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12$\n" +
	"\rclicktrackers\x18\x02 \x03(\tR\rclicktrackers\x12\x1a\n" +
	"\bfallback\x18\x03 \x01(\tR\bfallback*\x05\bd\x10\x90N\x1a\x9f\x04\n" +
	"\x05Asset\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x05R\x02id\x12!\n" +
	"\brequired\x18\x02 \x01(\b:\x05falseR\brequired\x129\n" +
	"\x05title\x18\x03 \x01(\v2#.openrtb.NativeResponse.Asset.TitleR\x05title\x125\n" +
	"\x03img\x18\x04 \x01(\v2#.openrtb.NativeResponse.Asset.ImageR\x03img\x129\n" +
	"\x05video\x18\x05 \x01(\v2#.openrtb.NativeResponse.Asset.VideoR\x05video\x126\n" +
	"\x04data\x18\x06 \x01(\v2\".openrtb.NativeResponse.Asset.DataR\x04data\x120\n" +
	"\x04link\x18\a \x01(\v2\x1c.openrtb.NativeResponse.LinkR\x04link\x1a\"\n" +
	"\x05Title\x12\x12\n" +
	"\x04text\x18\x01 \x02(\tR\x04text*\x05\bd\x10\x90N\x1a<\n" +
	"\x05Image\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12\f\n" +
	"\x01w\x18\x02 \x01(\x05R\x01w\x12\f\n" +
	"\x01h\x18\x03 \x01(\x05R\x01h*\x05\bd\x10\x90N\x1a9\n" +
	"\x04Data\x12\x14\n" +
	"\x05label\x18\x01 \x01(\tR\x05label\x12\x14\n" +
	"\x05value\x18\x02 \x02(\tR\x05value*\x05\bd\x10\x90N\x1a(\n" +
	"\x05Video\x12\x18\n" +
	"\avasttag\x18\x01 \x03(\tR\avasttag*\x05\bd\x10\x90N*\x05\bd\x10\x90N*\x05\bd\x10\x90N\"E\n" +
	"\aNetwork\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x16\n" +
	"\x06domain\x18\x03 \x01(\tR\x06domain\"\xf5\x01\n" +
	"\tUserAgent\x121\n" +
	"\bbrowsers\x18\x01 \x03(\v2\x15.openrtb.BrandVersionR\bbrowsers\x121\n" +
	"\bplatform\x18\x02 \x01(\v2\x15.openrtb.BrandVersionR\bplatform\x12\x16\n" +
	...
	"\x06source\x18\a \x01(\x05R\x06source\">\n" +
	"\fBrandVersion\x12\x14\n" +
	"\x05brand\x18\x01 \x02(\tR\x05brand\x12\x18\n" +
	"\aversion\x18\x02 \x03(\tR\aversionB\x15\n" +
	"\x13com.beeswax.openrtb"

var (
	file_beeswax_openrtb_openrtb_proto_rawDescOnce sync.Once
	file_beeswax_openrtb_openrtb_proto_rawDescData []byte
)

func file_beeswax_openrtb_openrtb_proto_rawDescGZIP() []byte {
	file_beeswax_openrtb_openrtb_proto_rawDescOnce.Do(func() {
		file_beeswax_openrtb_openrtb_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_beeswax_openrtb_openrtb_proto_rawDesc), len(file_beeswax_openrtb_openrtb_proto_rawDesc)))
	})
...
var file_beeswax_openrtb_openrtb_proto_msgTypes = make([]protoimpl.MessageInfo, 40)
var file_beeswax_openrtb_openrtb_proto_goTypes = []any{
	...
	(*Network)(nil),                                               // 6: openrtb.Network
	(*Channel)(nil),                                               // 7: openrtb.Channel
	(*UserAgent)(nil),                                             // 8: openrtb.UserAgent
	(*BrandVersion)(nil),                                          // 9: openrtb.BrandVersion
	(*BidRequest_Source)(nil),                                     // 10: openrtb.BidRequest.Source
	(*BidRequest_Impression)(nil),                                 // 11: openrtb.BidRequest.Impression
	(*BidRequest_Site)(nil),                                       // 12: openrtb.BidRequest.Site
	(*BidRequest_App)(nil),                                        // 13: openrtb.BidRequest.App
	(*BidRequest_Content)(nil),                                    // 14: openrtb.BidRequest.Content
	(*BidRequest_Device)(nil),                                     // 15: openrtb.BidRequest.Device
	(*BidRequest_User)(nil),                                       // 16: openrtb.BidRequest.User
	(*BidRequest_Publisher)(nil),                                  // 17: openrtb.BidRequest.Publisher
	(*BidRequest_Producer)(nil),                                   // 18: openrtb.BidRequest.Producer
	(*BidRequest_Geo)(nil),                                        // 19: openrtb.BidRequest.Geo
	(*BidRequest_Data)(nil),                                       // 20: openrtb.BidRequest.Data
	(*BidRequest_Regulations)(nil),                                // 21: openrtb.BidRequest.Regulations
	(*BidRequest_Impression_Banner)(nil),                          // 22: openrtb.BidRequest.Impression.Banner
	(*BidRequest_Impression_Video)(nil),                           // 23: openrtb.BidRequest.Impression.Video
	(*BidRequest_Impression_Native)(nil),                          // 24: openrtb.BidRequest.Impression.Native
	(*BidRequest_Impression_PMP)(nil),                             // 25: openrtb.BidRequest.Impression.PMP
	(*BidRequest_Impression_PMP_DirectDeal)(nil),                  // 26: openrtb.BidRequest.Impression.PMP.DirectDeal
	(*BidRequest_User_ExtendedID)(nil),                            // 27: openrtb.BidRequest.User.ExtendedID
	(*BidRequest_User_ExtendedID_UID)(nil),                        // 28: openrtb.BidRequest.User.ExtendedID.UID
	(*BidRequest_Data_Segment)(nil),                               // 29: openrtb.BidRequest.Data.Segment
	(*BidResponse_SeatBid)(nil),                                   // 30: openrtb.BidResponse.SeatBid
	(*BidResponse_SeatBid_Bid)(nil),                               // 31: openrtb.BidResponse.SeatBid.Bid
	(*NativeRequest_Asset)(nil),                                   // 32: openrtb.NativeRequest.Asset
	(*NativeRequest_Asset_Title)(nil),                             // 33: openrtb.NativeRequest.Asset.Title
	(*NativeRequest_Asset_Image)(nil),                             // 34: openrtb.NativeRequest.Asset.Image
	(*NativeRequest_Asset_Data)(nil),                              // 35: openrtb.NativeRequest.Asset.Data
	(*NativeResponse_Link)(nil),                                   // 36: openrtb.NativeResponse.Link
	(*NativeResponse_Asset)(nil),                                  // 37: openrtb.NativeResponse.Asset
	(*NativeResponse_Asset_Title)(nil),                            // 38: openrtb.NativeResponse.Asset.Title
	(*NativeResponse_Asset_Image)(nil),                            // 39: openrtb.NativeResponse.Asset.Image
	(*NativeResponse_Asset_Data)(nil),                             // 40: openrtb.NativeResponse.Asset.Data
	(*NativeResponse_Asset_Video)(nil),                            // 41: openrtb.NativeResponse.Asset.Video
	(Flag)(0),                                                     // 42: openrtb.Flag
	(*BidRequestExtensions)(nil),                                  // 43: openrtb.BidRequestExtensions
	(Enums_BidResponse_NoBidReason)(0),                            // 44: openrtb.Enums.BidResponse.NoBidReason
	(*BidResponseExtensions)(nil),                                 // 45: openrtb.BidResponseExtensions
	(Enums_BidRequest_Impression_NativeRequest_LayoutId)(0),       // 46: openrtb.Enums.BidRequest.Impression.NativeRequest.LayoutId
	(Enums_BidRequest_Impression_NativeRequest_AdUnitId)(0),       // 47: openrtb.Enums.BidRequest.Impression.NativeRequest.AdUnitId
	(Enums_BidRequest_Impression_NativeRequest_Context)(0),        // 48: openrtb.Enums.BidRequest.Impression.NativeRequest.Context
	(Enums_BidRequest_Impression_NativeRequest_ContextSubtype)(0), // 49: openrtb.Enums.BidRequest.Impression.NativeRequest.ContextSubtype
	(Enums_BidRequest_Impression_NativeRequest_PlacementType)(0),  // 50: openrtb.Enums.BidRequest.Impression.NativeRequest.PlacementType
	(*ImpressionExtensions)(nil),                                  // 51: openrtb.ImpressionExtensions
	(*SiteExtensions)(nil),                                        // 52: openrtb.SiteExtensions
	(*AppExtensions)(nil),                                         // 53: openrtb.AppExtensions
	(Enums_BidRequest_Content_VideoQuality)(0),                    // 54: openrtb.Enums.BidRequest.Content.VideoQuality
	(Enums_BidRequest_Content_Context)(0),                         // 55: openrtb.Enums.BidRequest.Content.Context
	(Enums_BidRequest_Content_SourceRelationship)(0),              // 56: openrtb.Enums.BidRequest.Content.SourceRelationship
	(Enums_BidRequest_Content_QAGMediaRating)(0),                  // 57: openrtb.Enums.BidRequest.Content.QAGMediaRating
	(*ContentExtensions)(nil),                                     // 58: openrtb.ContentExtensions
	(Enums_BidRequest_Device_ConnectionType)(0),                   // 59: openrtb.Enums.BidRequest.Device.ConnectionType
	(Enums_BidRequest_Device_DeviceType)(0),                       // 60: openrtb.Enums.BidRequest.Device.DeviceType
	(*DeviceExtensions)(nil),                                      // 61: openrtb.DeviceExtensions
	(*UserExtensions)(nil),                                        // 62: openrtb.UserExtensions
	(*PublisherExtensions)(nil),                                   // 63: openrtb.PublisherExtensions
	(*ProducerExtensions)(nil),                                    // 64: openrtb.ProducerExtensions
	(Enums_BidRequest_Geo_LocationType)(0),                        // 65: openrtb.Enums.BidRequest.Geo.LocationType
	(*GeoExtensions)(nil),                                         // 66: openrtb.GeoExtensions
	(*DataExtensions)(nil),                                        // 67: openrtb.DataExtensions
	(*RegulationsExtensions)(nil),                                 // 68: openrtb.RegulationsExtensions
	(Enums_BidRequest_Impression_AdPosition)(0),                   // 69: openrtb.Enums.BidRequest.Impression.AdPosition
	(Enums_BidRequest_Impression_Banner_AdType)(0),                // 70: openrtb.Enums.BidRequest.Impression.Banner.AdType
	(CreativeAttribute)(0),                                        // 71: openrtb.CreativeAttribute
	(Enums_BidRequest_Impression_Banner_ExpandableDirection)(0),   // 72: openrtb.Enums.BidRequest.Impression.Banner.ExpandableDirection
	(Enums_BidRequest_Impression_ApiFramework)(0),                 // 73: openrtb.Enums.BidRequest.Impression.ApiFramework
	(*BannerExtensions)(nil),                                      // 74: openrtb.BannerExtensions
	(Enums_BidRequest_Impression_Video_Linearity)(0),              // 75: openrtb.Enums.BidRequest.Impression.Video.Linearity
	(Enums_BidRequest_Impression_Video_Protocol)(0),               // 76: openrtb.Enums.BidRequest.Impression.Video.Protocol
	(Enums_BidRequest_Impression_Video_PlaybackMethod)(0),         // 77: openrtb.Enums.BidRequest.Impression.Video.PlaybackMethod
	(Enums_BidRequest_Impression_Video_ContentDelivery)(0),        // 78: openrtb.Enums.BidRequest.Impression.Video.ContentDelivery
	(Enums_BidRequest_Impression_Video_CompanionType)(0),          // 79: openrtb.Enums.BidRequest.Impression.Video.CompanionType
	(Enums_BidRequest_Impression_Video_VideoPlacementType)(0),     // 80: openrtb.Enums.BidRequest.Impression.Video.VideoPlacementType
	(Enums_BidRequest_Impression_Video_PlaybackCessationMode)(0),  // 81: openrtb.Enums.BidRequest.Impression.Video.PlaybackCessationMode
	(*VideoExtensions)(nil),                                       // 82: openrtb.VideoExtensions
	(*NativeExtensions)(nil),                                      // 83: openrtb.NativeExtensions
	(*PMPExtensions)(nil),                                         // 84: openrtb.PMPExtensions
	(*DirectDealExtensions)(nil),                                  // 85: openrtb.DirectDealExtensions
	(*SegmentExtensions)(nil),                                     // 86: openrtb.SegmentExtensions
	(*SeatBidExtensions)(nil),                                     // 87: openrtb.SeatBidExtensions
	(*BidExtensions)(nil),                                         // 88: openrtb.BidExtensions
}
var file_beeswax_openrtb_openrtb_proto_depIdxs = []int32{
	11,  // 0: openrtb.BidRequest.imp:type_name -> openrtb.BidRequest.Impression
	12,  // 1: openrtb.BidRequest.site:type_name -> openrtb.BidRequest.Site
	13,  // 2: openrtb.BidRequest.app:type_name -> openrtb.BidRequest.App
	15,  // 3: openrtb.BidRequest.device:type_name -> openrtb.BidRequest.Device
	16,  // 4: openrtb.BidRequest.user:type_name -> openrtb.BidRequest.User
	42,  // 5: openrtb.BidRequest.allimps:type_name -> openrtb.Flag
	21,  // 6: openrtb.BidRequest.regs:type_name -> openrtb.BidRequest.Regulations
	10,  // 7: openrtb.BidRequest.source:type_name -> openrtb.BidRequest.Source
	43,  // 8: openrtb.BidRequest.ext:type_name -> openrtb.BidRequestExtensions
	30,  // 9: openrtb.BidResponse.seatbid:type_name -> openrtb.BidResponse.SeatBid
	44,  // 10: openrtb.BidResponse.nbr:type_name -> openrtb.Enums.BidResponse.NoBidReason
	45,  // 11: openrtb.BidResponse.ext:type_name -> openrtb.BidResponseExtensions
	46,  // 12: openrtb.NativeRequest.layout:type_name -> openrtb.Enums.BidRequest.Impression.NativeRequest.LayoutId
	47,  // 13: openrtb.NativeRequest.adunit:type_name -> openrtb.Enums.BidRequest.Impression.NativeRequest.AdUnitId
	32,  // 14: openrtb.NativeRequest.assets:type_name -> openrtb.NativeRequest.Asset
	48,  // 15: openrtb.NativeRequest.context:type_name -> openrtb.Enums.BidRequest.Impression.NativeRequest.Context
	49,  // 16: openrtb.NativeRequest.contextsubtype:type_name -> openrtb.Enums.BidRequest.Impression.NativeRequest.ContextSubtype
	50,  // 17: openrtb.NativeRequest.plcmttype:type_name -> openrtb.Enums.BidRequest.Impression.NativeRequest.PlacementType
	37,  // 18: openrtb.NativeResponse.assets:type_name -> openrtb.NativeResponse.Asset
	36,  // 19: openrtb.NativeResponse.link:type_name -> openrtb.NativeResponse.Link
	9,   // 20: openrtb.UserAgent.browsers:type_name -> openrtb.BrandVersion
	9,   // 21: openrtb.UserAgent.platform:type_name -> openrtb.BrandVersion
	22,  // 22: openrtb.BidRequest.Impression.banner:type_name -> openrtb.BidRequest.Impression.Banner
	23,  // 23: openrtb.BidRequest.Impression.video:type_name -> openrtb.BidRequest.Impression.Video
	24,  // 24: openrtb.BidRequest.Impression.native:type_name -> openrtb.BidRequest.Impression.Native
	42,  // 25: openrtb.BidRequest.Impression.instl:type_name -> openrtb.Flag
	25,  // 26: openrtb.BidRequest.Impression.pmp:type_name -> openrtb.BidRequest.Impression.PMP
	51,  // 27: openrtb.BidRequest.Impression.ext:type_name -> openrtb.ImpressionExtensions
	42,  // 28: openrtb.BidRequest.Site.privacypolicy:type_name -> openrtb.Flag
	17,  // 29: openrtb.BidRequest.Site.publisher:type_name -> openrtb.BidRequest.Publisher
	14,  // 30: openrtb.BidRequest.Site.content:type_name -> openrtb.BidRequest.Content
	52,  // 31: openrtb.BidRequest.Site.ext:type_name -> openrtb.SiteExtensions
	42,  // 32: openrtb.BidRequest.App.privacypolicy:type_name -> openrtb.Flag
	42,  // 33: openrtb.BidRequest.App.paid:type_name -> openrtb.Flag
	17,  // 34: openrtb.BidRequest.App.publisher:type_name -> openrtb.BidRequest.Publisher
	14,  // 35: openrtb.BidRequest.App.content:type_name -> openrtb.BidRequest.Content
	53,  // 36: openrtb.BidRequest.App.ext:type_name -> openrtb.AppExtensions
	54,  // 37: openrtb.BidRequest.Content.videoquality:type_name -> openrtb.Enums.BidRequest.Content.VideoQuality
	55,  // 38: openrtb.BidRequest.Content.context:type_name -> openrtb.Enums.BidRequest.Content.Context
	42,  // 39: openrtb.BidRequest.Content.livestream:type_name -> openrtb.Flag
	56,  // 40: openrtb.BidRequest.Content.sourcerelationship:type_name -> openrtb.Enums.BidRequest.Content.SourceRelationship
	18,  // 41: openrtb.BidRequest.Content.producer:type_name -> openrtb.BidRequest.Producer
	57,  // 42: openrtb.BidRequest.Content.qagmediarating:type_name -> openrtb.Enums.BidRequest.Content.QAGMediaRating
	42,  // 43: openrtb.BidRequest.Content.embeddable:type_name -> openrtb.Flag
	6,   // 44: openrtb.BidRequest.Content.network:type_name -> openrtb.Network
	7,   // 45: openrtb.BidRequest.Content.channel:type_name -> openrtb.Channel
	58,  // 46: openrtb.BidRequest.Content.ext:type_name -> openrtb.ContentExtensions
	42,  // 47: openrtb.BidRequest.Device.dnt:type_name -> openrtb.Flag
	19,  // 48: openrtb.BidRequest.Device.geo:type_name -> openrtb.BidRequest.Geo
	42,  // 49: openrtb.BidRequest.Device.js:type_name -> openrtb.Flag
	59,  // 50: openrtb.BidRequest.Device.connectiontype:type_name -> openrtb.Enums.BidRequest.Device.ConnectionType
	60,  // 51: openrtb.BidRequest.Device.devicetype:type_name -> openrtb.Enums.BidRequest.Device.DeviceType
	8,   // 52: openrtb.BidRequest.Device.sua:type_name -> openrtb.UserAgent
	61,  // 53: openrtb.BidRequest.Device.ext:type_name -> openrtb.DeviceExtensions
	19,  // 54: openrtb.BidRequest.User.geo:type_name -> openrtb.BidRequest.Geo
	20,  // 55: openrtb.BidRequest.User.data:type_name -> openrtb.BidRequest.Data
	27,  // 56: openrtb.BidRequest.User.eids:type_name -> openrtb.BidRequest.User.ExtendedID
	62,  // 57: openrtb.BidRequest.User.ext:type_name -> openrtb.UserExtensions
	63,  // 58: openrtb.BidRequest.Publisher.ext:type_name -> openrtb.PublisherExtensions
	64,  // 59: openrtb.BidRequest.Producer.ext:type_name -> openrtb.ProducerExtensions
	65,  // 60: openrtb.BidRequest.Geo.type:type_name -> openrtb.Enums.BidRequest.Geo.LocationType
	66,  // 61: openrtb.BidRequest.Geo.ext:type_name -> openrtb.GeoExtensions
	29,  // 62: openrtb.BidRequest.Data.segment:type_name -> openrtb.BidRequest.Data.Segment
	67,  // 63: openrtb.BidRequest.Data.ext:type_name -> openrtb.DataExtensions
	42,  // 64: openrtb.BidRequest.Regulations.coppa:type_name -> openrtb.Flag
	68,  // 65: openrtb.BidRequest.Regulations.ext:type_name -> openrtb.RegulationsExtensions
	69,  // 66: openrtb.BidRequest.Impression.Banner.pos:type_name -> openrtb.Enums.BidRequest.Impression.AdPosition
	70,  // 67: openrtb.BidRequest.Impression.Banner.btype:type_name -> openrtb.Enums.BidRequest.Impression.Banner.AdType
	71,  // 68: openrtb.BidRequest.Impression.Banner.battr:type_name -> openrtb.CreativeAttribute
	42,  // 69: openrtb.BidRequest.Impression.Banner.topframe:type_name -> openrtb.Flag
	72,  // 70: openrtb.BidRequest.Impression.Banner.expdir:type_name -> openrtb.Enums.BidRequest.Impression.Banner.ExpandableDirection
	73,  // 71: openrtb.BidRequest.Impression.Banner.api:type_name -> openrtb.Enums.BidRequest.Impression.ApiFramework
	74,  // 72: openrtb.BidRequest.Impression.Banner.ext:type_name -> openrtb.BannerExtensions
	75,  // 73: openrtb.BidRequest.Impression.Video.linearity:type_name -> openrtb.Enums.BidRequest.Impression.Video.Linearity
	76,  // 74: openrtb.BidRequest.Impression.Video.protocols:type_name -> openrtb.Enums.BidRequest.Impression.Video.Protocol
	71,  // 75: openrtb.BidRequest.Impression.Video.battr:type_name -> openrtb.CreativeAttribute
	42,  // 76: openrtb.BidRequest.Impression.Video.boxingallowed:type_name -> openrtb.Flag
	77,  // 77: openrtb.BidRequest.Impression.Video.playbackmethod:type_name -> openrtb.Enums.BidRequest.Impression.Video.PlaybackMethod
	78,  // 78: openrtb.BidRequest.Impression.Video.delivery:type_name -> openrtb.Enums.BidRequest.Impression.Video.ContentDelivery
	69,  // 79: openrtb.BidRequest.Impression.Video.pos:type_name -> openrtb.Enums.BidRequest.Impression.AdPosition
	22,  // 80: openrtb.BidRequest.Impression.Video.companionad:type_name -> openrtb.BidRequest.Impression.Banner
	73,  // 81: openrtb.BidRequest.Impression.Video.api:type_name -> openrtb.Enums.BidRequest.Impression.ApiFramework
	79,  // 82: openrtb.BidRequest.Impression.Video.companiontype:type_name -> openrtb.Enums.BidRequest.Impression.Video.CompanionType
	80,  // 83: openrtb.BidRequest.Impression.Video.placement:type_name -> openrtb.Enums.BidRequest.Impression.Video.VideoPlacementType
	81,  // 84: openrtb.BidRequest.Impression.Video.playbackend:type_name -> openrtb.Enums.BidRequest.Impression.Video.PlaybackCessationMode
	82,  // 85: openrtb.BidRequest.Impression.Video.ext:type_name -> openrtb.VideoExtensions
	4,   // 86: openrtb.BidRequest.Impression.Native.request:type_name -> openrtb.NativeRequest
	73,  // 87: openrtb.BidRequest.Impression.Native.api:type_name -> openrtb.Enums.BidRequest.Impression.ApiFramework
	71,  // 88: openrtb.BidRequest.Impression.Native.battr:type_name -> openrtb.CreativeAttribute
	83,  // 89: openrtb.BidRequest.Impression.Native.ext:type_name -> openrtb.NativeExtensions
	42,  // 90: openrtb.BidRequest.Impression.PMP.private_auction:type_name -> openrtb.Flag
	26,  // 91: openrtb.BidRequest.Impression.PMP.deals:type_name -> openrtb.BidRequest.Impression.PMP.DirectDeal
	84,  // 92: openrtb.BidRequest.Impression.PMP.ext:type_name -> openrtb.PMPExtensions
	85,  // 93: openrtb.BidRequest.Impression.PMP.DirectDeal.ext:type_name -> openrtb.DirectDealExtensions
	28,  // 94: openrtb.BidRequest.User.ExtendedID.uids:type_name -> openrtb.BidRequest.User.ExtendedID.UID
	86,  // 95: openrtb.BidRequest.Data.Segment.ext:type_name -> openrtb.SegmentExtensions
	31,  // 96: openrtb.BidResponse.SeatBid.bid:type_name -> openrtb.BidResponse.SeatBid.Bid
	42,  // 97: openrtb.BidResponse.SeatBid.group:type_name -> openrtb.Flag
	87,  // 98: openrtb.BidResponse.SeatBid.ext:type_name -> openrtb.SeatBidExtensions
	5,   // 99: openrtb.BidResponse.SeatBid.Bid.adm_native:type_name -> openrtb.NativeResponse
	71,  // 100: openrtb.BidResponse.SeatBid.Bid.attr:type_name -> openrtb.CreativeAttribute
	88,  // 101: openrtb.BidResponse.SeatBid.Bid.ext:type_name -> openrtb.BidExtensions
	33,  // 102: openrtb.NativeRequest.Asset.title:type_name -> openrtb.NativeRequest.Asset.Title
	34,  // 103: openrtb.NativeRequest.Asset.img:type_name -> openrtb.NativeRequest.Asset.Image
	23,  // 104: openrtb.NativeRequest.Asset.video:type_name -> openrtb.BidRequest.Impression.Video
	35,  // 105: openrtb.NativeRequest.Asset.data:type_name -> openrtb.NativeRequest.Asset.Data
	0,   // 106: openrtb.NativeRequest.Asset.Image.type:type_name -> openrtb.NativeRequest.Asset.Image.ImageAssetType
	1,   // 107: openrtb.NativeRequest.Asset.Data.type:type_name -> openrtb.NativeRequest.Asset.Data.DataAssetType
	38,  // 108: openrtb.NativeResponse.Asset.title:type_name -> openrtb.NativeResponse.Asset.Title
	39,  // 109: openrtb.NativeResponse.Asset.img:type_name -> openrtb.NativeResponse.Asset.Image
	41,  // 110: openrtb.NativeResponse.Asset.video:type_name -> openrtb.NativeResponse.Asset.Video
	40,  // 111: openrtb.NativeResponse.Asset.data:type_name -> openrtb.NativeResponse.Asset.Data
	36,  // 112: openrtb.NativeResponse.Asset.link:type_name -> openrtb.NativeResponse.Link
...
func file_beeswax_openrtb_openrtb_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_beeswax_openrtb_openrtb_proto_rawDesc), len(file_beeswax_openrtb_openrtb_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   40,
			NumExtensions: 0,
			NumServices:   0,
